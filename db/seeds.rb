...
# Create some doctors
doctor1 = Doctor.create(name: 'Dr. John Doe', photo: "wwwwww",price_hour: 20, about: "what")
doctor2 = Doctor.create(name: 'Dr. Jane Smith', photo: "xxxxxxx", price_hour: 30, about: "whatever")
